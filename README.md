...
### Fieri Feature
For the Fieri feature to work properly, the following keys need to be set in the supermarket.rb file and supermarket need to be reconfigured using command `supermarket-ctl reconfigure`:
